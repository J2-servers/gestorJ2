    ...
    <div style={{ background: "#1a1a2e", border: "1px solid #2a2a3e", borderRadius: 12, padding: 12 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
        ...
        <div>
          ...
          <p style={{ margin: 0, fontSize: 10, color: change > 0 ? "#f87171" : "#10b981" }}>
      ...
      <ResponsiveContainer width="100%" height={150}>
        <LineChart data={history}>
          ...
          <Line type="monotone" dataKey="price" stroke="#8b5cf6" strokeWidth={2} dot={{ fill: "#a78bfa", r: 3 }} />
        </LineChart>
      </ResponsiveContainer>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 8 }}>
        <div style={{ background: "#0a0a0a", padding: "6px 8px", borderRadius: 6 }}>
          ...
          <p style={{ margin: 0, fontSize: 11, fontWeight: 700, color: "#10b981" }}>R$ {minPrice.toFixed(4)}</p>
        </div>
        <div style={{ background: "#0a0a0a", padding: "6px 8px", borderRadius: 6 }}>
