    ...
    <GlassCard className="p-4 lg:p-6" neonColor="blue">
      <div className="flex items-center justify-between mb-4 lg:mb-6">
        <div className="flex items-center gap-2 lg:gap-3">
          <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl lg:rounded-2xl bg-gradient-to-br from-orange-700 to-orange-950 flex items-center justify-center border-0 shadow-none">
        ...
        {topServers.map((server, index) => (
          ...
          >
            ...
            <div className="absolute -top-1 -left-1 lg:-top-2 lg:-left-2 z-10">
              <div className={`w-6 h-6 lg:w-8 lg:h-8 rounded-full bg-gradient-to-br ${rankColors[index % 5]} flex items-center justify-center shadow-none border-0`}>
            ...
            <div className="mt-2 lg:mt-3 h-1.5 lg:h-2 bg-[#080b0c] rounded-full overflow-hidden shadow-[inset_3px_3px_7px_rgba(0,0,0,0.5),inset_-2px_-2px_5px_rgba(255,255,255,0.012)]">
              <div
                className="h-full bg-gradient-to-r from-orange-700 to-orange-950 rounded-full transition-all duration-1000 shadow-none"
                style={{
